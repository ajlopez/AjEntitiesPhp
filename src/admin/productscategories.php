<?
	$PageTitle = 'Categor&iacute;as de Productos';
	$PagePrefix = '../';
	...
	$sql = "select Id, Description from products_categories order by Description";
	$rs = mysql_query($sql);
...
<p>
<a href="productscategoryform.php">Nueva Categor&iacute;a...</a>
<p>
...
function ShowRegister($reg) {
	...
	DatumLinkGenerate($reg["Description"], "productscategory.php?Id=".$reg["Id"]);
